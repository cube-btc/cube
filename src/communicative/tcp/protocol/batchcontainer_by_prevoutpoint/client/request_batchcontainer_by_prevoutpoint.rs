...
/// Timeout for Batch container-by-prevoutpoint requests.
const BATCHCONTAINER_BY_PREVOUTPOINT_REQUEST_TIMEOUT_MS: u64 = 5_000;

/// Sends a Batch container-by-prevoutpoint request over the peer's TCP connection.
pub async fn request_batchcontainer_by_prevoutpoint(
    peer: &PEER,
    ...
    let request_body = BatchContainerByPrevOutpointRequestBody::new(prev_payload_outpoint);
    ...
    BatchContainerByPrevOutpointResponseBody::deserialize(&response_payload)
