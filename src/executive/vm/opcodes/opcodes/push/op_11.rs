...
/// Pushes number 11 (0x0b) to the main stack.
...
impl OP_11 {
    pub fn execute(stack_holder: &mut StackHolder) -> Result<(), StackError> {
        ...
        stack_holder.increment_ops(OpcodeOpsParams::as_u32(stack_holder.opcode_ops().op_11))?;
    ...
    /// Returns the bytecode for the `OP_11` opcode (0x5b).
