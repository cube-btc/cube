use crate::constructive::entries::entry_types::liftup::ext::hash::sighash::error::sighash_error::LiftupSighashError;
...
impl Liftup {
    ...
    pub fn sighash(&self) -> Result<[u8; 32], LiftupSighashError> {
        ...
        // 2 Hash the sighash preimage with the 'SighashLiftup' tag.
        let sighash = sighash_preimage.hash(Some(HashTag::SighashLiftup));
