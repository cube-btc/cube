...
impl Entry {
    ...
    pub async fn decode_ape(
        ...
        let decode_start_remaining = if collect_bits {
            Some(bit_stream.len())
        } else {
            None
        };
                    ...
                    true => {
                        ...
                        match gateway_or_outer_right_branch_bit {
                            ...
                            true => {
                                ...
                                let outer_lowermost_or_reserved_branch_bit = bit_stream.next().ok_or(
                                ...
                                match outer_lowermost_or_reserved_branch_bit {
                                    ...
                                    false => {
                                        ...
                                        match deploy_or_config_bit {
                                            ...
                                            false => {
                                                let deploy_entry = Deploy::decode_ape(
                                                    execution_batch_height,
                                                    bit_stream,
                                                    decode_account_rank_as_longval,
                                                    registry,
                                                ...
                                                .await
                                                .map_err(
                                                    EntryAPEDecodeError::DeployEntryAPEDecodeError,
                                                )?;
                                                Entry::Deploy(deploy_entry)
                                            }

                                            // 2.b.2.b.1.b.1.a.2.b The `Entry` is a `Config`.
                                            true => {
                                                let config_entry = Config::decode_ape(
                                                    execution_batch_height,
                                                    bit_stream,
                                                    decode_account_rank_as_longval,
                                                    registry,
                                                ...
                                                .await
                                                .map_err(
                                                    EntryAPEDecodeError::ConfigEntryAPEDecodeError,
                                                )?;
