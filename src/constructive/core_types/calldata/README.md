...
| U32              | u32                     | Represents compact and possibly common values ranging from 0 to 4,294,967,295.              | 7-35 bits     | 0-4 bytes      |
| U64              | u64                     | Represents compact and possibly common values ranging from 0 to 18,446,744,073,709,551,615. | 7-68 bits     | 0-8 bytes      |
...
| Payable          | u32                     | Represents a Bitcoin payment.                                                               | 7-35 bits     | 0-4 bytes      |
